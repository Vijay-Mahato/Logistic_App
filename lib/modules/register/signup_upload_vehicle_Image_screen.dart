...
class SignUpUploadVehicleImageScreen extends StatelessWidget {
  final int vehicleId;
  SignUpUploadVehicleImageScreen({Key? key, required this.vehicleId}) : super(key: key);
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              pleaseUploadYourVehicleImage.tr,
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: primaryLogisticColor,
                            ...
                            InkWell(
                              onTap: () async {
                                await showDialog(context: context, builder: (context) => alertDialogSelectImage(context:context),).then((value) async {
                                  cubit.addVehicleImage(cubit.imageFile);
                                });
                              },
                              child: Container(
                            ...
                            Stack(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: cubit.vehicleImage!=null?Image.file(
                                    cubit.vehicleImage!,
                                    fit: BoxFit.cover,
                                  ): Image.network(
                                    'https://img.freepik.com/free-vector/modern-blue-urban-adventure-suv-vehicle-illustration_1344-205.jpg?w=1480&t=st=1687353759~exp=1687354359~hmac=5fa600e116d45b9d4746f756ed4d6af32b5ab677be6beb8d09ee6eeda9ed55cf',
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                if(cubit.vehicleImage!=null)
                                  InkWell(
                                    onTap: () {
                                      cubit.removeVehicleImage();
                                    },
                                    child: Padding(
                            ...
                            state is LogisticsUploadImageLoadingState? Center(child: AdaptiveIndicator(os: getOS()),) :logisticButton(
                              isMobileDevice: isMobileDevice,
                              onPressed: () {
                                if(cubit.vehicleImage!=null){
                                  cubit.uploadVehicleImage(vehicleId: vehicleId);
